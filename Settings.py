...
DESCRIPTIONS = {
    ...
    'pawn'            : ['moves two spaces orthogonally on it\'s first move.', '\'right click\' to harvest resources.',
                         'captures one space diagonally.'],
    'ferz'            : ['moves two spaces diagonally on it\'s first move.', '\'right click\' to harvest resources.',
                         'captures one space orthogonally.'],
    'builder'         : ['\'right click\' to spawn buildings.', 'buildings can spawn more powerful pieces.',
                         '\'right click\' to harvest resources.'],
    'monk'            : ['\'right click\' to pray at monoliths or prayer stones to cast powerful rituals.'],
    'pikeman'         : ['moves or captures one square in every direction.', 'a valuable defender.',
                         'can capture walls.'],
    'castle'          : ['\'right click\' to spawn essential pieces such as pawns and builders.'],
    'stable'          : ['\'right click\' to spawn leapers like knights and elephants.',
                         'all leapers can capture walls.'],
    'barracks'        : ['\'right click\' to spawn standard chess pieces such as rooks and bishops.'],
    'fortress'        : ['\'right click\' to spawn rogue version of the standard chess pieces.',
                         'rogue pieces move through forest tiles and steal resources from enemy pieces.'],
    'queen'           : ['the most powerful piece in a standard chess set.', 'slides to move and captures in all '
                                                                             'directions.',
                         '\'right click\' ban rituals for a resource cost unique to each map!'],
    'rook'            : ['slides to capture and attack orthogonally', '\'right click\' to pray at prayer sites.'],
    'bishop'          : ['slides to capture and attack diagonally', '\'right click\' to pray at prayer sites.'],
    'knight'          : ['leaps over another piece up two and over one.', 'able to capture walls.'],
    'jester'          : ['slides to move in all directions.',
                         'pieces nearby are distracted and make any actions such as moving or mining.'],
    'rogue_rook'      : ['slides to capture and attack orthogonally.', '\'right click\' to steal resources from enemy '
                                                                       'pieces.',
    ...
    'rogue_bishop'    : ['moves diagonally.',
                         ...
                         'can move through and land on forest tiles.'],
    'rogue_knight'    : ['leaps over another piece up two and over one.',
                         '\'right click\' to steal resources from enemy '
                         'pieces.' 'can land on forest tiles.', ],
    'rogue_pawn'      : ['moves two spaces orthogonally on it\'s first move.', '\'right click\' to harvest resources.',
                         '\'right click\' to steal resources from enemy pieces.',
                         'captures one space diagonally.', 'can move through and land on forest tiles.'],
    'oxen'            : ['leaps over another piece up two and over one.', 'after leaping, slides to move orthogonally.',
                         'can capture walls.'],
    ...
    'elephant'        : ['leaps over another piece up two and over one.',
                         ...
                         'can capture walls.'],
    'ram'             : ['leaps over another piece up two and over one,', 'then slides diagonally.',
                         'can capture walls.'],
    'unicorn'         : ['leaps over another piece up two and over one.',
                         'leaps over another piece two spaces orthogonally.',
                         'makes an additional knight move if nothing obstructs it\'s movement.', 'can capture walls.'],
    'monolith'        : ['\'right click\' to cast powerful rituals.', 'rituals cost prayer to use.',
                         'prayer is obtained by using a praying piece on a monolith or a prayer stone.'],
    'prayer_stone'    : ['\'right click\' to cast useful rituals.', 'rituals cost prayer to use.',
                         'prayer is obtained by using a praying piece on a monolith or a prayer stone.'],
    'duke'            : ['the brother of the queen.', 'slides to move and captures in all '
                                                      'directions.',
    ...
    'doe'             : ['leaps over another piece up two and over one.',
                         'slides to move diagonally.', 'can capture walls.'],
    ...
    'trader'          : ['\'right click\' to give one resource and receive another. ', 'the first menu that appears is the resource you give.',
                         'the second menu that appears is the resource you get.'],
    'circus'          : ['\'right click\' to spawn exotic chess pieces such as the jester and persuader.'],
    'lion'            : ['leaps over another piece up two and over one.',
                         'slides to move orthogonally.'],
    'fire_spinner'    : ['leaps over another piece up two and over one.',
                         'makes an additional 2 knight moves if nothing obstruct\'s it\'s movement'],
    'acrobat'         : ['slides to capture and attack diagonally',
...
ADDITIONAL_PIECE_LIMIT = {
    'castle'        : 5, 'barracks': 5, 'fortress': 3, 'stable': 3, 'circus': 3,
    'king'          : 0,
    'queen'         : 0,
    'rook'          : 0,
    'bishop'        : 0,
