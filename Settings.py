...
DESCRIPTIONS = {
    ...
    'builder'         : ['creates buildings', 'which can spawn more', 'powerful pieces'],
    ...
    'fortress'        : ['creates rogue versions of the standard chess pieces',
                         'rogue pieces move through forest tiles and steal resources from pieces of the opposite '
                         'color'],
    ...
    'jester'          : ['does not capture pieces', 'moves like a queen',
                         'pieces nearby are distracted and cannot act'],
    ...
    'cavalry'         : ['moves like a knight for it\'s first move',
