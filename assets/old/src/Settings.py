...
NOTIFICATIONS = {None: ['cannot select'],
                 ...
                 'piece_action': ['no pieces actions remaining'],
...
DESCRIPTIONS = {'king': ['every player gets one', 'capture your opponent\'s to win'],
                ...
                'queen': ['the most powerful pieces in a standard chess set', 'attacks orthogonally and diagonally',
                ...
                'rogue_rook': ['moves orthoganlly',
                               'can steal a resource of your choosing from a pieces of the opposite color',
                ...
                'smite': ['select one pieces or buildings to be destroyed'],
                ...
                'teleport': ['teleport a pieces anywhere else on the board'],
                'swap': ['trade places with another pieces'],
                ...
                'acrobat': ['moves like a bishop but can jump over a pieces'],
                'trapper': ['creates traps which, once moved onto', 'destroy the pieces that moved onto them'],
