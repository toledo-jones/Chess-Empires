...
class Engine:
    ...
    def __init__(self):
        ...
        self.piece_stealing_offsets.append(self.generate_stealing_offsets(Constant.STEALING_KEY['pieces']))

        self.building_stealing_offsets = []
        self.building_stealing_offsets.append(self.generate_stealing_offsets(Constant.STEALING_KEY['buildings']))
        ...
        self.STATES = {'playing': Playing,
                       ...
                       'pieces cost screen': PieceCost,
                       'buildings': PreBuilding,
                       'winner': Winner,
                       'surrender': Surrender,
        ...
        self.KIND_TO_STEALING_LIST = {'pieces': self.piece_stealing_offsets, 'buildings': self.building_stealing_offsets,
    ...
    def valid_purchase(self, cost):
        #
        #   Check each value in the cost of the pieces being spawned against
    ...
    def capture(self, moving_row, moving_col, dest_row, dest_col):
        ...
        #
        #   Move pieces to newly emptied square
        #
