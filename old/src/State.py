...
class SelectStartingPieces(State):
    ...
    def __init__(self, win, engine):
        ...
        self.instruction_text_font = pygame.font.Font(os.path.join("../fonts", "font.ttf"), self.instruction_text_font_size)
