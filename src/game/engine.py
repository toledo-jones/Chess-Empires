...
class GameEngine(Singleton):
    def __init__(self,
        ...
        # Debug
        from src.game.entities.units.acrobat import Acrobat
        acrobat = Acrobat(0, 0, 'black')
    ...
    def draw_test_building(self) -> None:
        """
        Draws a test building on the screen.

        The method emits a 'test' event using the event manager with information about
        the test building's sprite path, type, position, and origin.
        """
